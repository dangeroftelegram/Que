...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/dangeroftelegram/Queen_pro)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template= https://github.com/dangeroftelegram/Queen_pro.git)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/b0db36b7d7e577f9aabef.jpg"
else:
  img = START_IMG    
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/Danger_of_telegram")]]))
        return
